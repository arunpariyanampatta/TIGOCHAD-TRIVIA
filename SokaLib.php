...
var $amount,$msisdn,$sokaServicesObj;
public function __construct($msisdn,$amount) {   
    
    $this->amount = $amount;
    $this->msisdn = $msisdn;
    $this->sokaServicesObj = new SokaServices("consumer");
...
function sendSMS($txnID,$moID,$type,$sms){
$mobile = $this->msisdn;    
$sms = urlencode($sms);  
$smsID = $this->sokaServicesObj->recordSms($this->msisdn, $txnID, $moID, $type, urldecode($sms));
